...
![image.png](/Volumes/Wen‘s SSD/Webpack5 核心原理与应用实践/assets/f6384383d6df4060b973bd3ad8f261eb~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![image.png](/Volumes/Wen‘s SSD/Webpack5 核心原理与应用实践/assets/6d735d771f4c4436bc0b80e145098314~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
![image.png](/Volumes/Wen‘s SSD/Webpack5 核心原理与应用实践/assets/c51ac80e214c41b2b695b2ea71e5ab33~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
...
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| ![img](/Volumes/Wen‘s SSD/Webpack5 核心原理与应用实践/assets/c1b556bae1db4654a01cd0ceddd43701~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp) | `/* ... */ .sprite(@sprite) {   .sprite-image(@sprite);   .sprite-position(@sprite);   .sprite-width(@sprite);   .sprite-height(@sprite); } /* ... */ ` |
...
![image.png](/Volumes/Wen‘s SSD/Webpack5 核心原理与应用实践/assets/9f14b1077cf14b2196bf051e4eded84a~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp)
